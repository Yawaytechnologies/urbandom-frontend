...
const ListingMain = ({ activeSubmenu }) => {
  ...
  return (
    <div className="p-2 sm:p-4 min-h-screen bg-[#f5f5f5]">
      {/* Filter Bar */}
      <div className="bg-gradient-to-r from-[#e9ddff] to-[#f4eaff] rounded-[20px] px-3 sm:px-6 py-3 sm:py-4 shadow-sm border border-[#ecd8ff] max-w-6xl mx-auto transition-all duration-300">
        <div className="flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center justify-between gap-2 sm:gap-4">
  ...
  return (
    <div className="relative min-w-0" ref={ref}>
      <button
        ...
        className="w-full bg-white border border-gray-300 text-sm text-black px-3 py-1.5 rounded-xl shadow-sm hover:bg-gray-100 flex items-center gap-2 transition"
      >
        Property Id
        <FaChevronDown
      ...
      {show && (
        <div className="absolute z-10 mt-2 w-[90vw] max-w-xs sm:w-72 left-0 bg-white border border-gray-200 rounded-xl shadow-md p-4">
          <input
            type="text"
            value={value}
...
const LocalityDropdown = () => {
  ...
  return (
    <div className="relative min-w-0" ref={ref}>
      ...
      {open && (
        <div className="absolute z-10 mt-2 w-[90vw] max-w-xs sm:w-64 left-0 bg-white border border-gray-200 rounded-xl shadow-md p-3">
          <input
            type="text"
...
const PropertyTypeDropdown = () => {
  ...
  return (
    <div className="relative min-w-0" ref={ref}>
      ...
      {open && (
        <div className="absolute z-10 mt-2 w-[95vw] max-w-md sm:w-[400px] left-0 bg-white border border-gray-200 rounded-xl shadow-md p-4 flex flex-wrap gap-3">
          {options.map((option) => {
...
const SimpleDropdown = ({ label, options }) => {
  ...
  return (
    <div className="relative min-w-0" ref={ref}>
      ...
      {open && (
        <div className="absolute z-10 mt-2 w-[70vw] max-w-xs sm:w-48 left-0 bg-white border border-gray-200 rounded-xl shadow-md p-3">
          {options.map((option) => (
            <div
              key={option}
