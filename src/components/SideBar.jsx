...
import LoginModal from '../pages/auth/userlogin';   // Adjust the path
import SignupModal from '../pages/auth/usersignup'; // Adjust the path
      ...
      >
        ...
        <div className="p-6 pt-12 text-sm">
          ...
          <button
            ...
            className="bg-green-500 hover:bg-green-600 text-white text-sm font-semibold px-6 py-2 rounded-full w-full mb-6"
          >
            Login
          </button>
