...
const PropertyOverviewPage = () => {
  return (
    <div className="w-full min-h-screen bg-[#f7f7f7] pt-[20px]">
      ...
      {/* Sticky Navigation Tabs - scroll removed */}
      ...
      {/* Main Layout */}
      <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_22rem] px-4 sm:px-6 md:px-10 lg:px-20 py-6 gap-6">
        ...
        {/* RIGHT: Sticky Scrollable Contact Form */}
